...
`theredirector.github.io` is a CNAME for `redirect.grpnx.org`.
...
[`https://git.io/example`](https://git.io/example) &#8594; `https://theredirector.github.io/?https://example.com` &#8594; `http://redirect.grpnx.org/?https://example.com` &#8594; [`https://example.com`](https://example.com).
